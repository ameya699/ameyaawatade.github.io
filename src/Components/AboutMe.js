  ...
  return (
    <div className="about-me-div" id="about">
      <h1 className="about-me-description">
        <h1 className="about-me-heading">About Me</h1>I am passionate about Full
        Stack Development and excel in using a diverse skill set that includes
        Express, React, Node, Power Apps, Power Automate, and TIBCO. I have
        ...
        my knowledge. Apart from coding, I also enjoy designing, sketching cars
        and dancing. If there's an opportunity to contribute to a revolutionary
        project, I'm eager to discuss it.
        <button
